...
if (isset($_GET['ec_ruta']) && isset($_GET['ec_cuenta'])) {
    ...
    $total_pagado = $infoContrato['ctr_total_pagado'] === NULL || $infoContrato['ctr_total_pagado'] === 'NULL' ? 0 : $infoContrato['ctr_total_pagado'];
    $total_aux_pagado = intval($infoContrato['ctr_enganche']) + intval($infoContrato['ctr_pago_adicional']);
...
<tr style="font-size:8px">
    <td style="border-top:1px solid #ccc" >$abonos[abs_id]</td>
    <td style="border-top:1px solid #ccc" >$abonos[abs_folio]</td>
    <td style="border-top:1px solid #ccc" >$abonos[usr_nombre]</td>
    ...
    <td style="border-top:1px solid #ccc" >$abonos[abs_estado_abono]<br>$abonos[abs_motivo_cancelacion]</td>
</tr>
