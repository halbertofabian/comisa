<?php
if (isset($rutas[1]) && $rutas[1] != "" && $rutas[2] != "") :
    $flujo_usr = $rutas[1];
    $usr_caja = $rutas[2];
?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            buscarFlujoCajaCerrada(<?php echo $flujo_usr ?>, <?php echo $usr_caja ?>)
        })
    </script>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="copn_saldo">Introduce la cantidad de retiro</label>
                                            <input type="text" name="copn_saldo" id="copn_saldo" class="form-control inputN" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="copn_ingreso_banco">Introduce la cantidad en banco</label>
                                            <input type="text" name="copn_ingreso_banco" id="copn_ingreso_banco" readonly class="form-control inputN" placeholder="Transaferencias / Depositos / Pagos con Tarjeta">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="copn_ingreso_efectivo_usuario" id="copn_ingreso_efectivo_usuario" class="form-control inputN" required readonly >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
