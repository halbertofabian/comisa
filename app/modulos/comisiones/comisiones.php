...
<div class="container">
    <form method="post" id="formCalculoComisiones">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <button type="button" class="btn btn-primary btn-load float-right mb-5 " id="btnRepComision">Buscar</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    <label for="igs_deuda_int">Deuda Interna (Prestamo semanal)</label>
                    <input type="text" name="igs_deuda_int" id="igs_deuda_int" class="form-control inputN" readonly placeholder="">
                </div>
            </div>
        </div>
        <div class="row">
