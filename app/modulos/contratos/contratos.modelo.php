...
class ContratosModelo
{
    ...
    public static function mdlActualizarPreContratos($ctr)
    {
        try {
            ...
            $sql = "UPDATE tbl_contrato_crt_1 SET ctr_cliente =?,ctr_numero_cuenta = ?, ctr_ruta = ? , ctr_forma_pago = ?,ctr_dia_pago = ? , ctr_proximo_pago = ?, ctr_plazo_credito = ?, ctr_total = ?, ctr_enganche = ?, ctr_pago_adicional = ?, ctr_saldo = ?, ctr_nombre_ref_1 = ?, ctr_parentesco_ref_1 = ?, ctr_direccion_ref_1 = ?,ctr_colonia_ref_1 = ?, ctr_telefono_ref_1 = ?, clts_curp = ?, clts_telefono = ?,clts_domicilio = ?, clts_col = ?, clts_entre_calles = ?, clts_trabajo = ?, clts_puesto = ?, clts_direccion_tbj = ?, clts_col_tbj = ?, clts_tel_tbj = ?,    clts_antiguedad_tbj = ?, clts_igs_mensual_tbj = ?, clts_tipo_vivienda = ?, clts_vivienda_anomde = ?, clts_antiguedad_viviendo = ?, clts_coordenadas = ?, clts_nom_conyuge = ?, clts_tbj_conyuge = ?, clts_tbj_puesto_conyuge = ?, clts_tbj_dir_conyuge = ?, clts_tbj_col_conyuge = ?, clts_tbj_tel_conyuge = ?, clts_tbj_ant_conyuge = ?, clts_tbj_ing_conyuge = ?, clts_nom_fiador = ?, clts_parentesco_fiador = ?, clts_tel_fiador  = ?, clts_dir_fiador = ?, clts_col_fiador = ?, clts_tbj_fiador = ?, clts_tbj_dir_fiador = ?, clts_tbj_tel_fiador = ?, clts_tbj_col_fiador = ?,clts_tbj_ant_fiador = ?, clts_nom_ref2 = ?, clts_parentesco_ref2 = ?, clts_dir_ref2 = ?, clts_col_ref2 = ?, clts_tel_ref2 = ?, clts_nom_ref3 = ?, clts_parentesco_ref3 = ?, clts_dir_ref3 = ?, clts_col_ref3 = ?, clts_tel_ref3 = ?, sobre_enganche_pendiente = ? , ctr_pago_credito = ?,ctr_aprovado_ventas = ? , ctr_fecha_contrato = ?, clts_fachada_color =? , clts_puerta_color = ? , ctr_status_cuenta =?, ctr_saldo_actual=?, ctr_total_pagado=?, ctr_id_vendedor=?, ctr_elaboro=? WHERE ctr_id = ? ";
            $con = Conexion::conectar();
            $pps = $con->prepare($sql);
            ...
            $pps->bindValue(12, $ctr['ctr_nombre_ref_1']);
            $pps->bindValue(13, $ctr['ctr_parentesco_ref_1']);
            $pps->bindValue(14, $ctr['ctr_direccion_ref_1']);
            $pps->bindValue(15, $ctr['ctr_colonia_ref_1']);
            $pps->bindValue(16, $ctr['ctr_telefono_ref_1']);
            $pps->bindValue(17, $ctr['clts_curp']);
            $pps->bindValue(18, $ctr['clts_telefono']);
            $pps->bindValue(19, $ctr['clts_domicilio']);
            $pps->bindValue(20, $ctr['clts_col']);
            $pps->bindValue(21, $ctr['clts_entre_calles']);
            $pps->bindValue(22, $ctr['clts_trabajo']);
            $pps->bindValue(23, $ctr['clts_puesto']);
            $pps->bindValue(24, $ctr['clts_direccion_tbj']);
            $pps->bindValue(25, $ctr['clts_col_tbj']);
            $pps->bindValue(26, $ctr['clts_tel_tbj']);
            $pps->bindValue(27, $ctr['clts_antiguedad_tbj']);
            $pps->bindValue(28, $ctr['clts_igs_mensual_tbj']);
            $pps->bindValue(29, $ctr['clts_tipo_vivienda']);
            $pps->bindValue(30, $ctr['clts_vivienda_anomde']);
            $pps->bindValue(31, $ctr['clts_antiguedad_viviendo']);
            $pps->bindValue(32, $ctr['clts_coordenadas']);
            $pps->bindValue(33, $ctr['clts_nom_conyuge']);
            $pps->bindValue(34, $ctr['clts_tbj_conyuge']);
            $pps->bindValue(35, $ctr['clts_tbj_puesto_conyuge']);
            $pps->bindValue(36, $ctr['clts_tbj_dir_conyuge']);
            $pps->bindValue(37, $ctr['clts_tbj_col_conyuge']);
            $pps->bindValue(38, $ctr['clts_tbj_tel_conyuge']);
            $pps->bindValue(39, $ctr['clts_tbj_ant_conyuge']);
            $pps->bindValue(40, $ctr['clts_tbj_ing_conyuge']);
            $pps->bindValue(41, $ctr['clts_nom_fiador']);
            $pps->bindValue(42, $ctr['clts_parentesco_fiador']);
            $pps->bindValue(43, $ctr['clts_tel_fiador']);
            $pps->bindValue(44, $ctr['clts_dir_fiador']);
            $pps->bindValue(45, $ctr['clts_col_fiador']);
            $pps->bindValue(46, $ctr['clts_tbj_fiador']);
            $pps->bindValue(47, $ctr['clts_tbj_dir_fiador']);
            $pps->bindValue(48, $ctr['clts_tbj_tel_fiador']);
            $pps->bindValue(49, $ctr['clts_tbj_col_fiador']);
            $pps->bindValue(50, $ctr['clts_tbj_ant_fiador']);
            $pps->bindValue(51, $ctr['clts_nom_ref2']);
            $pps->bindValue(52, $ctr['clts_parentesco_ref2']);
            $pps->bindValue(53, $ctr['clts_dir_ref2']);
            $pps->bindValue(54, $ctr['clts_col_ref2']);
            $pps->bindValue(55, $ctr['clts_tel_ref2']);
            $pps->bindValue(56, $ctr['clts_nom_ref3']);
            $pps->bindValue(57, $ctr['clts_parentesco_ref3']);
            $pps->bindValue(58, $ctr['clts_dir_ref3']);
            $pps->bindValue(59, $ctr['clts_col_ref3']);
            $pps->bindValue(60, $ctr['clts_tel_ref3']);
            $pps->bindValue(61, $ctr['sobre_enganche_pendiente']);
            $pps->bindValue(62, $ctr['ctr_pago_credito']);
            $pps->bindValue(63, $ctr['ctr_aprovado_ventas']);
            $pps->bindValue(64, $ctr['ctr_fecha_contrato']);
            $pps->bindValue(65, $ctr['clts_fachada_color']);
            $pps->bindValue(66, $ctr['clts_puerta_color']);
            $pps->bindValue(67, $ctr['ctr_status_cuenta']);
            $pps->bindValue(68, $ctr['ctr_saldo_actual']);
            $pps->bindValue(69, $ctr['ctr_total_pagado']);
            $pps->bindValue(70, $ctr['ctr_id_vendedor']);
            $pps->bindValue(71, $ctr['ctr_elaboro']);
