    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.usr_caja == 0) {
                ...
                var rutaQr = urlApp + 'media/qr/QR'+res.usr_caja+'.png';
...
function buscarFlujoCajaCerrada(flujo_usr, usr_caja) {
    // if (flujo_usr == "") {
    //     toastr.warning("Seleccione un usuario para continuar", 'Por favor');
    //     $(".btn-open-cash").addClass('d-none');
    //     $(".btn-close-cash").addClass('d-none');
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (usr_caja == 0) {
                ...
                buscarIngesosByCaja(usr_caja, res.usr_id)
                buscarGastosByCaja(usr_caja, res.usr_id)
